...
export class RegistroMascotaComponent implements OnInit {
  ...
  constructor(
    ...
    const idsExistentes = this.mascotaService.getAll().map(m => m.idMascota);
  ...
  getErrorMessage(controlName: string): string {
    ...
    if (control.errors['idDuplicado']) {
      return 'Este ID de mascota ya existe';
    }
  ...
  onSubmit(): void {
    ...
    const mascota: Mascota = this.petForm.value;
    this.mascotaService.create(mascota);
